...
public class ScheduleAppointmentPage extends AndroidActions {
	AndroidDriver driver;

	public ScheduleAppointmentPage(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='Purpose Detail']")
	...
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='Are you sure to cancel the appointment ?']")
	...
	public Boolean BreedingIndividualVerification() throws InterruptedException {
		...
		if (Breeding.isDisplayed()  && Breeding.getText().equals("Pre-breeding Examination")&& Farmvisit.isDisplayed()&& Farmvisit.getText().equals("Doctor - Farm Visit")&& pestControl.isDisplayed() && pestControl.getText().equals("Pest Control") && Vaccination.isDisplayed()
				&& Vaccination.getText().equals("Vaccination")	&& Export.isDisplayed() && Export.getText().equals("Health Examination for Exporting")) {
			val = true;
			System.out.println(
			...
			Thread.sleep(5000);
			if (purposefield.isDisplayed() && purposefield.getText().equals("Purpose") && Clinic.isDisplayed() && Clinic.getText().equals("Clinic")&& ClinicName.isDisplayed() && ClinicName.getText().equals("Clinic Name")
					&& AnimalType.isDisplayed() && AnimalType.getText().equals("Animal Type")&& BookAppointmentbtn.isDisplayed() && BookAppointmentbtn.getText().equals("Book an appointment")) {
				val = true;
				System.out.println(
			...
			//	System.out.println("Clinic is not selected, alert message displayed");
				...
				// if individual animal is selected");
			} else {
	...
	public Boolean appointmentidverification() throws InterruptedException {
		...
		if (BookingId.isDisplayed() && BookingId.getText().equals("Booking ID")) {
	...
	public void verifypestcontrolTagIdBookingbtn() throws InterruptedException {
		if (ConfirmationTitle.isDisplayed() && ConfirmationTitle.getText().equals("Confirmation")) {
			System.out.println("Booking button verified,confirmation title is displayed");
			if (CLinicName.isDisplayed() && CLinicName.getText().equals("Clinic Name")&& BookingId.isDisplayed() && BookingId.getText().equals("Booking ID")&& RequestMsg.isDisplayed() && RequestMsg.getText().equals("Request has been successfully sent")
					&& ConfirmationText.isDisplayed() && ConfirmationText.getText().equals("Confirmation")&& TickMark.isDisplayed()) {
			...
			if(Okbtn.isDisplayed() && Okbtn.getText().equals("Ok"))
			{
			Okbtn.click();
	...
	public Boolean FarmVisitValidation() throws InterruptedException {
		...
		if (Breeding.isDisplayed()  && Breeding.getText().equals("Pre-breeding Examination")&& Farmvisit.isDisplayed()&& Farmvisit.getText().equals("Doctor - Farm Visit")&& pestControl.isDisplayed() && pestControl.getText().equals("Pest Control") && Vaccination.isDisplayed()
			...
			if (purposefield.isDisplayed() && purposefield.getText().equals("Purpose")&& comment.isDisplayed() && comment.getText().equals("Comments")&& Clinic.isDisplayed()&&Clinic.getText().equals("Clinic")&& ClinicName.isDisplayed()&& ClinicName.getText().equals("Clinic Name")
					&& BookAppointmentbtn.isDisplayed()&& BookAppointmentbtn.getText().equals("Book an appointment")) {
				val = true;
...
*/
		...
		if (comment.isDisplayed()) {
			...
			System.out.println("Commnets is not displayed");
		}
	...
	public void VerifyAnimaltype()  {	
		if (Individual.isDisplayed() && Individual.getText().equals("Individual")&& Herd.isDisplayed() && Herd.getText().equals("Herd")) {
	...
	public void ClickIndividual() {
		...
		if (speciesListName.isDisplayed() && speciesListName.getText().equals("Species")&& TagId.isDisplayed()&& TagId.getText().equals("Tag ID")) {
	...
	public void ClickHerd() {
		if (Herd.isDisplayed() && Herd.getText().equals("Herd")) {
	...
	public void VerifySpeciesHerd() {
		...
		if (cattle.isDisplayed() && cattle.getText().equals("Cattle") && sheep.isDisplayed() && sheep.getText().equals("Sheep")&& goat.isDisplayed() && goat.getText().equals("Goat")) {
	...
	public void ClickTagIdEmpty() {
		if (Individual.isDisplayed() && Individual.getText().equals("Individual")) {
	...
	public Boolean ClinicList() throws InterruptedException {
		...
		if (privateClinic.isDisplayed() && privateClinic.getText().equals("Private")  && publicclinic.isDisplayed() && publicclinic.getText().equals("Public")) {
			val = true;
