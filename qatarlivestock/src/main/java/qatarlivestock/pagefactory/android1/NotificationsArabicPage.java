...
public class NotificationsArabicPage extends AndroidActions {	

		AndroidDriver driver;

		public  NotificationsArabicPage (AndroidDriver driver) {
			super(driver);
			this.driver = driver;
		...
		@AndroidFindBy(xpath= ".//android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/androidx.appcompat.widget.LinearLayoutCompat[2]")
		...
		@AndroidFindBy(xpath = ".//android.widget.TextView[@text='إشعارات']")
		...
		@AndroidFindBy(xpath = ".//android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.TextView[1]")
		...
		@AndroidFindBy(xpath= ".//android.widget.TextView[@text='اتصل بالمكلف']")
			...
			if (hambergerelmnt.isDisplayed()) {
				...
				if (Notification.isDisplayed()) {
					...
					if (NotificationlistTitle.isDisplayed()) {
						...
						String Expectednotification = "إشعارات";
