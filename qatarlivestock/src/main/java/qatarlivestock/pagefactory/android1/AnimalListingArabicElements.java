...
public class AnimalListingArabicElements extends AndroidActions {
 
	AndroidDriver driver;
	AppiumUtils utils = new AppiumUtils();
 
	public AnimalListingArabicElements(AndroidDriver driver)
	...
	@AndroidFindBy(xpath = ".//androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout/android.widget.ImageView")
	...
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='عدد الأنواع']")
	...
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='البيانات الديموغرافية']")
	...
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='اسم حارس الحيوان']")
	private WebElement animalKeeperNameTitle;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='تاريخ الميلاد']")
	private WebElement dobTitle;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='تكاثر']")
	private WebElement breedTitle;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='رقم جواز السفر']")
	private WebElement passportTitle;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='غاية']")
	private WebElement purposeTitle;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='سجلات طبية']")
	...
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='معلومات التتبع']")
	...
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='بلد المنشأ']")
	private WebElement countryOfOrigin;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='تاريخ الاستيراد']")
	private WebElement dateOfImport;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='وسيلة تنقل']")
	private WebElement modeOfTransport;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='استيراد دفعة رقم']")
	private WebElement importBatchNo;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='فترة الحجر الصحي']")
	private WebElement quarantinePeriod;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='المالك الحالي والفرضية']")
	private WebElement currentOwnerandPremise;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='في موعد']")
	private WebElement inDate;
 
	@AndroidFindBy(xpath = ".//android.widget.TextView[@text='وثيقة التتبع']")
	...
	public boolean animallistingpagetitleverification(String speciesname) throws InterruptedException {
		Thread.sleep(5000);
	...
	public int searchBtnfieldverification(String searchString) throws InterruptedException {
		if (searchField.isDisplayed() && searchField.getText().equals("البحث عن طريق معرف العلامة")) {
			//searchField.click();
			searchField.clear();
			...
			try {
				if (searchFieldNoData.isDisplayed() && searchFieldNoData.getText().equals("لا تتوافر بيانات")) {
					return 1;
				}
			} catch (Exception e) {
...
&& otherstext.isDisplayed()) {
	...
	public boolean animalsdetailsverification(String speciesname) {
		int j = 0;
		System.out.println("No of animals listed: "+animalbox.size());
		if (animalbox.size() == 0) {
		...
		else 
		{
			for (int i = 0; i < animalbox.size()-1; i++) {
				if (animalicon.get(i).isDisplayed() && healthstatus.get(i).isDisplayed() && animalid.get(i).isDisplayed()
...
&& rfidTag.isDisplayed() && rfidTag.getText().equals("علامة RFID ") && rfidTagText.isDisplayed()
&& rfidTagText.getText().length() == 16 && status.isDisplayed()
&& status.getText().equals("حالة ") && statusText.isDisplayed()) 
			{
				  if (statusText.getText().equals("ميت")) 
				  { 
					  try 
					  { 
	...
	public boolean verifydemographictitle() {
		if (demographicDetailsTitle.isDisplayed() && demographicDetailsTitle.getText().equals("البيانات الديموغرافية")) {
	...
	public boolean demographicdataverification(String speciesname) {
		if (demographicDataTab.isDisplayed()) {
			// demographicDataArrow.Click();
			if (speciesTitle.isDisplayed() && speciesTitle.getText().equals("صِنف") && speciesField.isDisplayed()
&& speciesField.getText().equalsIgnoreCase(speciesname) && ageTitle.isDisplayed()
&& ageTitle.getText().equals("عمر") && ageField.isDisplayed() && genderTitle.isDisplayed()
&& genderTitle.getText().equals("جنس") && genderField.isDisplayed()
&& animalKeeperNameTitle.isDisplayed()
&& animalKeeperNameTitle.getText().equals("اسم حارس الحيوان")
&& animalKeeperNameField.isDisplayed() && dobTitle.isDisplayed()
&& dobTitle.getText().equals("تاريخ الميلاد") && dobField.isDisplayed() && breedTitle.isDisplayed()
&& breedTitle.getText().equals("تكاثر") && breedField.isDisplayed() && passportTitle.isDisplayed()
&& passportTitle.getText().equals("رقم جواز السفر") && passportNoField.isDisplayed()
&& purposeTitle.isDisplayed() && purposeTitle.getText().equals("غاية")
&& purposeField.isDisplayed()) {
	...
	public boolean verifymedicalrecords() {
		demographicDataArrow.click();
		if (medicalRecordsTitle.isDisplayed() && medicalRecordsTitle.getText().equals("سجلات طبية")) {
	...
	public int medicalrecordsdatavalidation() {
		...
		if (medicalRecordsDataTab.isDisplayed()) {
			try {
				if (medicalRecordsNoData.isDisplayed() && medicalRecordsNoData.getText().equals("لا تتوافر بيانات")) {
...
&& doctorName.get(i).isDisplayed() && recordsNxtBtn.get(i).isDisplayed()) {
							...
							utils.waitForElementToAppear(diagnosisTitle, "text", "تشخبص", driver);
...
&& vaccinationsdataverification()) {
	...
	public boolean verifymedicalrecordpagetitle() {
		if (medicalRecordTitle.isDisplayed() && medicalRecordTitle.getText().equals("سجلات طبية")) {
...
&& regNo.isDisplayed() && recordDate.isDisplayed() && recordTime.isDisplayed()) {
	...
	public int medicaldiagnosisverification() {
		try 
		{
			if (diagnosisTitle.isDisplayed() && diagnosisTitle.getText().equals("تشخبص")
&& diagnosisNoData.isDisplayed()) // return 1 when no data displayed and return 2 when data present. Add
			...
			{
				if (diagnosisNoData.getText().equals("لا تتوافر بيانات")) {
	...
	public boolean verifytreatmentplantitle() {
		if (treatmentPlanTitle.isDisplayed() && treatmentPlanTitle.getText().equals("خطة علاجية")) {
	...
	public boolean treatmentplandataverification() {
		if (treatmentPlanDataTab.isDisplayed()) {
			try {
				if (treatmentPlanNoData.isDisplayed() && treatmentPlanNoData.getText().equals("لا تتوافر بيانات")) {
...
&& remarksTextField.get(i).isDisplayed()) {
	...
	public boolean verifymedicinesissuedtitle() {
		treatmentPlanArrow.click();
		if (medicinesIssuedTitle.isDisplayed() && medicinesIssuedTitle.getText().equals("الأدوية الصادرة")) {
...
&& medicinesIssuedNoData.getText().equals("للا تتوافر بيانات")) {
...
&& commentsTextField.get(i).isDisplayed()) {
	...
	public boolean verifymedicinesdispensedtitle() {
		medicinesIssuedArrow.click();
		if (medicinesDispensedTitle.isDisplayed() && medicinesDispensedTitle.getText().equals("الأدوية التي تم الاستغناء عنها")) {
...
&& medicinesDispensedNoData.getText().equals("للا تتوافر بيانات")) {
	...
	public boolean verifyvaccinetitle() {
		medicinesDispensedArrow.click();
		if (vaccinationsTitle.isDisplayed() && vaccinationsTitle.getText().equals("اللقاحات")) {
	...
	public boolean vaccinationsdataverification() {
		...
		if (vaccinationsDataTab.isDisplayed()) {
			if (vaccinationsNoData.isDisplayed() && vaccinationsNoData.getText().equals("للا تتوافر بيانات")) {
	...
	public boolean verifytracebilityinfotitle() {
		medicalDetailsArrowBtn.click();
		if (tracebilityInfoTitle.isDisplayed() && tracebilityInfoTitle.getText().equals("معلومات التتبع")) {
...
&& tracebilityDocumentTitle.getText().equals("وثيقة التتبع")) {
...
&& traceabilityDocumentNoData.getText().equals("لا تتوافر بيانات")) {
